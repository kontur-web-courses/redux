...
export default function Sandglass({seconds}) {
  ...
  return (
    <div className="sandglass">
      <div className="sandglassTop"></div>
      <div className="sandglassMiddle">
        <div className="glass"></div>
        <div className="topSand" style={{
        ...
        ></div>
        <div className="sandStream" style={{
          display: sandRate % 60 === 0 ? 'none' : 'block'
        }}></div>
        <div className="bottomSand" style={{
          borderBottomWidth: `${Math.floor(2 + 98*(60 - sandRate)/60)}px`,
          borderLeftWidth: `${2 + 60 - sandRate}px`,
          borderRightWidth: `${2 + 60 - sandRate}px`,
          right: `-${2 + 60 - sandRate}px`
        }}></div>
      </div>
      <div className="sandglassBottom"></div>
    </div>
  );
}
